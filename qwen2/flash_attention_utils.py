...
def _flash_attention_forward(
    ...
    Args:
        ...
        use_top_left_mask (`bool`, defaults to `False`):
            ...
            while what is needed here is bottom-right alignment,
...
def _flash_attention_packed_forward(
        query_states: torch.Tensor,
        key_states: torch.Tensor,
        value_states: torch.Tensor,
        is_causal: bool,
    ...
    # print("FLASH ATTENTION RUNNING!!!! ", flush=True)
    total = query_states.size(0)
    ...
    attn_output = attn_output.view(total, attn_output.size(-2), attn_output.size(-1))
