...
class EncoderLayer(nn.Module):
    ...
    :param src.nets.backend.transformer.attention.
        MultiHeadedAttention self_attn: self attention module
        RelPositionMultiHeadedAttention self_attn: self attention module
    :param src.nets.backend.transformer.positionwise_feed_forward.
        PositionwiseFeedForward feed_forward:
        feed forward module
    :param src.nets.backend.transformer.convolution.
