...
class Llama3AVProcessorKwargs(ProcessingKwargs, total=False):
    _defaults = {
        "text_kwargs": {
            "padding": False,
        },
...
class Llama3AVProcessor(ProcessorMixin):
    r"""
    ...
    def __call__(
            ...
            **kwargs: Unpack[Llama3AVProcessorKwargs],
    ) -> BatchFeature:
        """
