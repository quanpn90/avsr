...
def process_anyres_image(image, processor, grid_pinpoints):
    ...
    # FIXME: the processor.size of SigLIP is a tuple like (384, 384), and has no attribute 'shortest_edge'
    try:
        image_original_resize = image.resize((processor.size['shortest_edge'], processor.size['shortest_edge'])) # CLIP
    except:
        image_original_resize = image.resize((processor.size[0], processor.size[0])) # SigLIP
